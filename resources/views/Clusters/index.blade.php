...
@section('title', __("site.Clusters"))
@section('id', 'LocalElectoralLists')

@push('style')
    <link rel="stylesheet" href="{{asset('/css/LocalElectoralLists.css')}}">
@endpush
@section('content')
    <x-layout.header-image title="{{__('site.Clusters')}}"></x-layout.header-image>
            ...
            @forelse($clusters as $cluster)
                <div class="Candidate-votes-card">
                    ...
                    <div class="Candidate-votes-card-content">
                        ...
                        <a href="{{route('clusters.show', ['cluster' => $cluster])}}" class="secondary-btn align-self-center mb-3">
                            @lang('site.Show Cluster')
