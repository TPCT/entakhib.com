...
@section('title', __("site.Candidates"))
...
@endpush
@section('content')
    <x-layout.header-image title="{{__('site.Candidates')}}"></x-layout.header-image>
    ...
    <section class="mb-3">
        <div class="container">
            <section class="about-our-services-section container">
                ...
                <section>
                    <div class="container @if($candidates->count()) Candidate-votes-container @endif">
                            ...
                            <div class="Candidate-votes-card">
                                ...
                                <div class="Candidate-votes-card-content">
                                    <div>
                                        ...
                                        <h3>{{$candidate->party?->title ?? $candidate->cluster?->title}}</h3>
                                        <h3>{{$candidate->slogan}}</h3>
                                    </div>
                                    <a href="{{route('candidates.show', ['candidate' => $candidate])}}" class="secondary-btn align-self-center mb-3">
                                        @lang('site.Profile')
                                        <svg
                                                width="21"
                                                height="21"
